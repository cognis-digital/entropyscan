#!/usr/bin/env sh
# Universal installer for entropyscan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/entropyscan.git"
echo "Installing entropyscan ..."
...
echo "Done. Run: entropyscan --help"
