"""ENTROPYSCAN command-line interface."""
from __future__ import annotations
import argparse, sys
from entropyscan.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="entropyscan", description="ENTROPYSCAN — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from entropyscan.mcp_server import serve
        return serve()
    if args.cmd == "scan":
